 ...
 * @author paulo
 */
public class SorteadorThreadsSync {
    
    static int[] num_sorteados;
    static int tam;
    static volatile int num_validos;
    ...
    public synchronized static boolean armazena_numero(int num, String thread){
            ...
            if(valido){
                ...
                System.out.println(thread + "O numero "+num+" é invalido e não foi armazenado na posicao "+tam);
            }
            System.out.println("O tamanho atual e: "+tam);
            return valido;
        ...
        public void run() {
            try{
                int num;
                while(tam<100){
                    num = ThreadLocalRandom.current().nextInt(0,100)+1;
